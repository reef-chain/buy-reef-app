...
export const authenticate = async (address: string): Promise<AuthenticationResponse | undefined> => {
  ...
  if (signRaw != null) {
    ...
    return post<AuthenticationResponse>('/jwt', { address: address, signature });
  }
